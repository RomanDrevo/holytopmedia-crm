<!-- Modal -->
<div id="createWithdrawalSplitModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="/sales/create-new-withdrawal-split" id="split_form">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="withdrawal_employee_id" id="withdrawal_employee_id" value="">
                        <input type="hidden" name="withdrawal_amount" id="withdrawal_amount" value="">
                    </div>
                    <input type="submit" value="SPLIT WITHDRAWAL" class="btn btn-success">
                </form>
            </div>
