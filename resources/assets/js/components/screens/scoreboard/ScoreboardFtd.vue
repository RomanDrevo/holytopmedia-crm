<template>
    ...
    <div class="container-fluid ftd-container">
        <div ref="top"></div>
        ...
        <div id="main_table">
            <table id="score_board">
                ...
                <tr v-for="(employee, index) in allEmployees">
                    ...
                    <td>{{ employee.monthly }}</td>
                    <td>{{ employee.upsale }}</td>
                    <td>{{ leftToGoal(employee.monthly, employee.monthly_goal) }}</td>
                    <td>{{ employee.monthly_goal }}</td>
                </tr>
                </tbody>
            </table>
        </div>
