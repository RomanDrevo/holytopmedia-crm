    ...
    <div class="container">
        ...
        <div class="panel uploader">
            <div class="panel-heading">
                ...
                <p>Upload a .csv file of existing customers</p>
            </div>
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td>customer_id (required)</td>
                        <td>The customer's ID must be a first column</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>country_id (optional)</td>
                        <td>The ID of the customer's country (you can download the list of ID below this table)</td>
                    </tr>
                    <tr>
                        <td>campaign_id (optional)</td>
                        <td>Must be a valid campaign id in the CRM</td>
                    </tr>
                    <tr>
                        <td>subcampaign_name (optional)</td>
                        <td>Any name could work here.</td>
                    </tr>
                    <tr>
                        <td>currency (optional)</td>
                        <td>One of the following: USD, GBP, EUR, NIS</td>
                    </tr>
                    <tr>
                        <td>affiliate_id (optional)</td>
                        <td>The customer's Affiliate ID</td>
                    </tr>
                    </tbody>
                </table>

                <p>
                    <a href="/downloads/edit_customers_example.csv" class="btn btn-xs btn-primary">edit customer.csv example
                        file</a>
...
<script type="text/babel">
    ...
    export default {
        ...
        created(){
            ...
            this.channel = this.pusher.subscribe('edit_updates_channel_' + this.user_id);
        ...
        methods: {
            uploadCustomers(e){
                ...
                this.$http.post('/upload/edit-customers/proccess-file', formData).then((response) => {
                ...
                this.channel.bind('update_recieved', (data) => {
                    switch (data.action) {
                        ...
                        case "processing_error":
                            this.errors = '';
                            this.proccessing = true;
                            this.errors = data.payload.error;
                            break;

                        case "customers_uploaded":
                            this.customersUpdated += 1;
                        ...
                        case "upload_complete":
                            this.loadingMessage = "Done! (" + this.completed + " customers updated)";
                            break;
                    }
                });
            },
